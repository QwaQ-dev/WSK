...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 14 2024 г., 10:39
...
(21, 'Lorem ipsum', 24.3883, 52.3882, 1, 1, 'Attraction', '1731568288748', '10:00:00', NULL, 'Lorem ipsum dolor sit amet de param static.');
...
(307, 1, 4, 5, '13:00:00', '14:05:00', 180, 80, NULL),
(308, 1, 1, 2, '15:00:00', '14:05:00', 180, 80, 'AVAILABLE');
...
--
-- Дамп данных таблицы `schedule_choices`
--

INSERT INTO `schedule_choices` (`id`, `from_place_id`, `to_place_id`, `segments_hash`, `selects_count`) VALUES
(1, 1, 2, '6bc68cc282b8bbafb467bb3e8d611bf7', 1);
...
--
-- Дамп данных таблицы `schedule_choice_segments`
--

INSERT INTO `schedule_choice_segments` (`id`, `schedule_id`, `schedule_choice_id`, `order`) VALUES
(1, 1, 1, 1),
(2, 3, 1, 2);
...
(1, 'admin', '$2b$06$fFqxG0q4Ezy6k.AvPCFftO1uHn4xPM2ztHbDdLgSPIxyh.6z8L7Bu', '1efa2570-6615-6030-a41a-077daac88f64', 1),
